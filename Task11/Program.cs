...
int[] GenerateArray(int n)                             // int[] array = new int[n];     
{                                                      // for (int i = 0; i < n; i++)
int[] array = new int[n];                              // {
...
void PrintArray(int[] array)                           // for (int i = 0; i < n; i++)
{                                                      // {
...
void SumNumbersRanks(int[] array)                      // double sum = 0;
{                                                      // for (int i = 0; i < n; i++)
double sum = 0;                                        // {
for (int i = 0; i < array.Length; i++)                 // sum += array[i] * Math.Pow(10, n - i - 1);
{                                                      // }
sum += array[i] * Math.Pow(10, array.Length - i - 1);  // Console.WriteLine(sum);
}
